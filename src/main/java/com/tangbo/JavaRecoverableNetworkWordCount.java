...
//			outputFile.delete();
//		}
//		SparkConf sparkConf = new SparkConf().setAppName("JavaRecoverableNetworkWordCount").setMaster("local[*]").set("spark.streaming.blockInterval", "15s")
...
//		final int port = 9999;
//		final String checkpointDirectory = "target/checkpoint";
